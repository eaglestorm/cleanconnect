...
namespace CleanConnect.Core.Model.Authorization
{
    ...
    /// </remarks>
    public class AuthenticationRequest: Base<LongIdentity>, IValidator
    {
        ...
        {
           init(scopes,responseType,client,redirectUri,state);  
        }
        ...
        public AuthenticationRequest(LongIdentity id, string scopes, ResponseType responseType,Client.Client client, string redirectUri, string state, string nonce, Display display,
            Prompts prompts, DateTimeOffset maxAge, IList<CultureInfo> locales, string tokenHint, DateTime createdDate, DateTime modifiedDate)
        ...
        /// </summary>
        public ScopesRequest Scopes { get; private set; }
        ...
        {
            return Prompts == null || Prompts.Contains(Prompt.Login);
        }

        public bool ShowConsent()
        {
            return !ShowLogin() && Prompts != null && Prompts.Contains(Prompt.Consent);
        }

        public bool ShowSelectAccount()
        {
            return !ShowLogin() && Prompts != null && Prompts.Contains(Prompt.SelectAccount);
        }

        public bool IsNonePrompt()
        {
            return Prompts != null && Prompts.Contains(Prompt.None);
        }
        ...
        private void init(string scopes, ResponseType responseType,Client.Client client, string redirectUri, string state)
        {
