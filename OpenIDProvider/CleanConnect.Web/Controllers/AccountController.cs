...
namespace CleanConnect.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUseCase<ProcessRequestMessage, ProcessRequestResponseMessage> authenticationUseCase, IMapper mapper)
        {
        ...
        public IActionResult Index(AuthenticationRequestDto dto)
        {
            ...
            if (string.IsNullOrEmpty(loginFlow.RedirectUrl))
            {
                return BadRequest(loginFlow.Error);
            }
